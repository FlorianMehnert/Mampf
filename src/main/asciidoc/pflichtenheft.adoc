...
Im folgenden sind alle Personen aufgelistet die einen Einfluss auf den Entwicklungsprozess haben können. Zur besseren Konflikt- und Problmbewältigung wird jeder Personengruppe eine Priorität zugeordnet um festzulegen wer im Streitfall letztendlich die Entscheidung fällt.
...
| v0.1
| Katalog
a| Das Programm muss alle Angebote in einem Katalog unveränderlich zur Verfügung stellen.
...
[[home_image]]
image::./images/gui_prototyp/kunden.png[kunden, 100%, 100%, pdfwidth=100%, title= "Kunden-Seite: Übersicht der Kundenkontos", align=center]

[[home_image]]
image::./images/gui_prototyp/mitarbeiter.png[mitarbeiter, 100%, 100%, pdfwidth=100%, title= "Mitarbeiter-Seite: Übersicht der Mitarbeiter (Service-Personal und Köchen)", align=center]
...
[[home_image]]
image::./images/gui_prototyp/bestellungen_personal_checkliste_gebucht.png[bestellungen4, 100%, 100%, pdfwidth=100%, title= "Bestellungen-Seite:  Wenn man den 'Service-Personal hinzufügen' Button drückt, aber einige Personal sind schon gebucht", align=center]
...
[[home_image]]
image::./images/diagrams/UMLAnalyse.svg[bestellungen5, 100%, 100%, pdfwidth=100%, align=center]
...
| EventcateringApp
a| Das ist die zentrale Klasse, die das Programm für die Organisation der Eventcatering-Firma enthält.


| [[inventory]] Inventory
a| Das Inventar listet, welche <<itemCategory,Ausrüstung>> in welcher Stückzahl verfügbar sind.
...
| Catalog (Katalog)
a| Der Katalog speichert alle Angebote. Er ermöglicht das Erstellen neuer Angebote und das Filtern nach <<itemCategory, Kategorien>>.
...
:domain_ref: Siehe <<class_enumerations, Klassen und Enumerationen>>
