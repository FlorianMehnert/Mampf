...
|{Result}     a|
-	Ein Fehler-Nachricht wird gezeigt, um der User über das Problem zu informieren (der User existiert schon).
|===
...
-	Wenn es nicht genügend Personal für den Termin gibt, muss ein Fehler-Nachricht gezeigt werden.
|===
