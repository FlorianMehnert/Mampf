...
[[home_image]]
image::./images/gui_prototyp/katalog_new.png[katalog1, 100%, 100%, pdfwidth=100%, title= "Katalog-Seite: Übersicht der Katalog", align=center]
...
|{Result}     a|
-	Der User wird eine Übersicht von den verschiedenen Typen von täglichen Angeboten (2), Frühstückstermin und Zwischensumme.
-	Wenn der User angemeldet ist, kann er eine Order bestellen (Anzahl der gewählte Typ, Termin und Adresse hinzufügen).
|===
...
-	Wenn es eine Überweisung ist, wird der Bankkonto des Caterings gezeigt.
